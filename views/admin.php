    ...
    <div class="dashboard">
        ...
        <main class="content">
            ...
            ?>
                ...
                echo '<label>Imię: <input type="text" name="imie" value="' . htmlspecialchars($manager['imie']) . '"></label><br>';
                echo '<label>Nazwisko: <input type="text" name="nazwisko" value="' . htmlspecialchars($manager['nazwisko']) . '"></label><br>';
                echo '<label>PESEL: <input type="text" name="pesel" value="' . htmlspecialchars($manager['pesel']) . '"></label><br>';
                echo '<label>Mail: <input type="email" name="mail" value="' . htmlspecialchars($manager['mail']) . '"></label><br>';
                echo '<label>Login: <input type="text" name="login" value="' . htmlspecialchars($manager['login']) . '"></label><br>';
                echo '<label>Hasło: <input type="password" name="password" value="' . htmlspecialchars($manager['password']) . '"></label><br>';
