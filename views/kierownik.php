        ...
        <main class="content">
            ...
            ?>
                ...
                <form method="POST" action="">
                    ...
                    <select name="rola" id="mail" required>
            ...
            ?>
                ...
                echo '<input type="hidden" name="id_osoby" value="' . htmlspecialchars($employer['id_osoby']) . '">';
                echo '<label>Imię: <input type="text" name="imie" value="' . htmlspecialchars($employer['imie']) . '"></label><br>';
                echo '<label>Nazwisko: <input type="text" name="nazwisko" value="' . htmlspecialchars($employer['nazwisko']) . '"></label><br>';
                echo '<label>PESEL: <input type="text" name="pesel" value="' . htmlspecialchars($employer['pesel']) . '"></label><br>';
                echo '<label>Mail: <input type="email" name="mail" value="' . htmlspecialchars($employer['mail']) . '"></label><br>';
            ...
            ?>
                ...
                echo '<form action="" method="post">';
                echo '<label>Marka: <input type="text" name="marka" value="' . htmlspecialchars($vehicle['marka']) . '"></label><br>';
                echo '<label>Model: <input type="text" name="model" value="' . htmlspecialchars($vehicle['model']) . '"></label><br>';
                echo '<label>Dane serwisowe: <input type="text" name="dane_serwisowe" value="' . htmlspecialchars($vehicle['dane_serwisowe']) . '"></label><br>';
                echo '<label>Rok produkcji: <input type="text" name="naped" value="' . htmlspecialchars($vehicle['rok_produkcji']) . '"></label><br>';
                echo '<label for="rola">Status:</label>
                <select name="status" id="rola">
                ...
                echo '<br>';
                echo '<label>data przeglądu: <input type="text" name="data_przegladu" value="' . htmlspecialchars($vehicle['data_przegladu']) . '"></label><br>';
                echo '<label>przebieg: <input type="text" name="przebieg" value="' . htmlspecialchars($vehicle['przebieg']) . '"></label><br>';
                echo '<button type="submit" name="edit_manager">Zapisz zmiany</button>';
                echo '</form>';
                ?>
            ...
            ?>
                ...
                <form method="POST" action="">
                    ...
                    <input type="text" id="imie" name="marka" required>

                    <label for="model">Model:</label>
                    <input type="text" id="nazwisko" name="model" required>

                    <label for="dane_serwisowe">Dane serwisowe:</label>
                    <input type="text" id="pesel" name="dane_serwisowe" value="brak danych">

                    <label for="rok_produkcji">Rok produkcji:</label>
                    <input type="text" id="mail" name="rok_produkcji" required>

                    <label for="status">Status:</label>
                    <select name="status" id="mail" value="dostepny">
                    ...
                    <input type="date" id="login" name="data_przegladu" required>

                    <label for="przebieg">Przebieg:</label>
                    <input type="text" id="password" name="przebieg" required>
