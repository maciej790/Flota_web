    ...
    <div class="dashboard">
        ...
        <main class="content">
            ...
            function formularzPrzegladu($serviceManager)
            {
                ...
                echo '<label>data ostatniego przeglądu: <input type="date" name="data_przegladu" value="' . htmlspecialchars($vehicle['data_przegladu']) . '"></label><br>';
            ...
            function formularzSerwisowania($serviceManager)
            {
                ...
                echo '<label>Dane serwisowe: <input type="text" name="dane_serwisowe"></label><br>';
